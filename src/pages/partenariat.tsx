...
const articles: { img: ImgProps | ImgProps[]; text: string; btnText?: string }[] = [
    {
        img: { src: "/images/partenariat/body-1.png", alt: "", width: 500, height: 400 },
        text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip.",
        btnText: "Contact",
    },
    {
        img: { src: "/images/partenariat/body-2.png", alt: "", width: 500, height: 400 },
        text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip.",
    },
];
...
export default function Page() {
    return (
        <>
            <Hero title="Partenariat & Sponsoring" img={{ src: "/images/partenariat/hero.png", alt: "banniere" }} />
